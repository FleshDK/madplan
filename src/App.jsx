...
const madplan = [
  ...
  },
  {
    ...
    dato: "04.05",
    emoji: "🍖",
    meal: "Rester fra nakkefilet 🍖",
    color: "#f5e6d3",
    accent: "#8b4513",
    naering: {
      hel: { kcal: 2800, protein: 260, kulhy: 160, fedt: 120 },
      portion: { kcal: 700, protein: 65, kulhy: 40, fedt: 30 },
    },
    recipe: {
      tid: "60 min",
      svaerhed: "Let",
      intro: "Perfekt resteret-ret! Nakkefilet fra søndagen opvarmes med lidt bouillon til mørt og saftigt kød. Nem og økonmisk! 🍖",
      trin: [
        "Tag restene af nakkefileten fra søndagen.",
        "Skær kødet i passende stykker.",
        "Læg det i et ildfast fad dækt med låg eller stanniol.",
        "Hæld 2-3 dl bouillon eller vand (evt. blandet med fløde) over kødet.",
        "Bag det ved 150°C i 45-60 min til det er helt varmt og mørt.",
        "Server med bådekartofler, ris eller kartofler efter behag.",
        "Sousen fra kødet kan tjykkes med maizena hvis ønsket. Lækkert! 🍖",
      ],
    },
    ingredients: [
      { name: "Nakkefilet (rester fra søndag)", qty: "ca. 500g", url: "https://www.bilkatogo.dk/s?query=nakkefilet" },
      { name: "Kvægfond/bouillon", qty: "2-3 dl", url: "https://www.bilkatogo.dk/s?query=fond" },
      { name: "Bådekartofler", qty: "1,5 kg", url: "https://www.bilkatogo.dk/s?query=kartofler" },
      { name: "Fløde (evt.)", qty: "1 dl", url: "https://www.bilkatogo.dk/s?query=flode" },
      { name: "Smør", qty: "25g", url: "https://www.bilkatogo.dk/s?query=smor" },
      { name: "Salt og peber", qty: "efter smag", url: "https://www.bilkatogo.dk/s?query=krydderier" },
      { name: "Maizena (evt. tykner)", qty: "evt.", url: "https://www.bilkatogo.dk/s?query=maizena" },
    ],
  },
  {
    day: "Tirsdag",
