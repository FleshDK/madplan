...
// Madplan uge 24 · 2026 · 08.06–14.06.2026
// Opdateret af MasterKOK 👨‍🍳 søndag 07. juni 2026
// Fryseren var tom — alle varer brugt i uge 23. Mandag: Alberte navlepiercing kl. 16:20–17:20 → hurtig ret valgt
...
const madplan = [
  {
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk pasta carbonara til familien. Serveres med brød.",
      trin: [
        "Forbered pasta carbonara efter opskrift.",
        "Tilbered brød som tilbehør.",
        "Smag til med salt og peber.",
        "Server og nyd måltidet! 🍽️",
      ],
    },
    ingredients: [
      { name: "Pasta", qty: "", url: "https://www.bilkatogo.dk/s?query=pasta" },
      { name: "Bacon", qty: "", url: "https://www.bilkatogo.dk/s?query=bacon" },
      { name: "Æg", qty: "", url: "https://www.bilkatogo.dk/s?query=æg" },
      { name: "Parmesanost (lille mængde)", qty: "", url: "https://www.bilkatogo.dk/s?query=parmesanost+(lille+mængde)" },
      { name: "Fløde", qty: "", url: "https://www.bilkatogo.dk/s?query=fløde" },
    ],
  },
  {
    day: "Tirsdag",
    ...
    sidedish: "Grøn salat",
    note: "Rester fra mandag opvarmet eller koldt",
    color: "#fff8e1",
    accent: "#f57f17",
    naering: {
      hel: { kcal: 2800, protein: 200, kulhy: 240, fedt: 90 },
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk pasta carbonara (rester fra mandag) til familien. Serveres med grøn salat.",
      trin: [
        "Forbered pasta carbonara (rester fra mandag) efter opskrift.",
        "Tilbered grøn salat som tilbehør.",
        "Smag til med salt og peber.",
        "Server og nyd måltidet! 🍽️",
      ],
    },
    ingredients: [
      { name: "Rester fra mandag", qty: "", url: "https://www.bilkatogo.dk/s?query=rester+fra+mandag" },
    ],
  },
  {
    day: "Onsdag",
    dato: "10.06",
    emoji: "🥘",
    meal: "Hakket Oksekød i Fad (Millionbøf)",
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk hakket oksekød i fad (millionbøf) til familien. Serveres med kartoflemos.",
      trin: [
        "Forbered hakket oksekød i fad (millionbøf) efter opskrift.",
        "Tilbered kartoflemos som tilbehør.",
        "Smag til med salt og peber.",
        "Server og nyd måltidet! 🍽️",
      ],
    },
    ingredients: [
      ...
      { name: "Bouillon", qty: "", url: "https://www.bilkatogo.dk/s?query=bouillon" },
      { name: "Fløde", qty: "", url: "https://www.bilkatogo.dk/s?query=fløde" },
  ...
  },
  {
    ...
    sidedish: "Kartoflemos",
    note: "Restemad — opvarmet fra onsdag",
    color: "#fbe9e7",
    accent: "#bf360c",
    naering: {
      hel: { kcal: 2800, protein: 200, kulhy: 240, fedt: 90 },
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk millionbøf (rester fra onsdag) til familien. Serveres med kartoflemos.",
      trin: [
        "Forbered millionbøf (rester fra onsdag) efter opskrift.",
        "Tilbered kartoflemos som tilbehør.",
        "Smag til med salt og peber.",
        "Server og nyd måltidet! 🍽️",
      ],
    ...
    ingredients: [
      { name: "Rester fra onsdag", qty: "", url: "https://www.bilkatogo.dk/s?query=rester+fra+onsdag" },
    ],
  },
  {
    day: "Fredag",
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk fiskefilet med persillesovs til familien. Serveres med kogte kartofler.",
      trin: [
        "Forbered fiskefilet med persillesovs efter opskrift.",
        "Tilbered kogte kartofler som tilbehør.",
        "Smag til med salt og peber.",
        "Server og nyd måltidet! 🍽️",
      ],
    },
    ingredients: [
      { name: "Fiskefilet (torsk eller lignende)", qty: "", url: "https://www.bilkatogo.dk/s?query=fiskefilet+(torsk+eller+lignende)" },
      { name: "Fløde", qty: "", url: "https://www.bilkatogo.dk/s?query=fløde" },
      { name: "Persille", qty: "", url: "https://www.bilkatogo.dk/s?query=persille" },
      { name: "Kartofler", qty: "", url: "https://www.bilkatogo.dk/s?query=kartofler" },
      { name: "Salt & peber", qty: "", url: "https://www.bilkatogo.dk/s?query=salt+&+peber" },
    ],
  },
  {
    day: "Lørdag",
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk hjemmelavede burgere til familien. Serveres med pomfritter.",
      trin: [
        "Forbered hjemmelavede burgere efter opskrift.",
        "Tilbered pomfritter som tilbehør.",
        "Smag til med salt og peber.",
        "Server og nyd måltidet! 🍽️",
      ],
    },
    ingredients: [
      { name: "Hakket oksekød", qty: "", url: "https://www.bilkatogo.dk/s?query=hakket+oksekød" },
      { name: "Burgerbuns", qty: "", url: "https://www.bilkatogo.dk/s?query=burgerbuns" },
      { name: "Salat", qty: "", url: "https://www.bilkatogo.dk/s?query=salat" },
      { name: "Tomat", qty: "", url: "https://www.bilkatogo.dk/s?query=tomat" },
      { name: "Løg", qty: "", url: "https://www.bilkatogo.dk/s?query=løg" },
      { name: "Ost", qty: "", url: "https://www.bilkatogo.dk/s?query=ost" },
      { name: "Poteter til pomfritter", qty: "", url: "https://www.bilkatogo.dk/s?query=poteter+til+pomfritter" },
    ],
  },
  {
    day: "Søndag",
    ...
    sidedish: "Ris",
    note: "Søndagsmad — kylling med krydderiet, bagte grøntsager og ris",
    color: "#f3e5f5",
    accent: "#7b1fa2",
    naering: {
      hel: { kcal: 2800, protein: 200, kulhy: 240, fedt: 90 },
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk kyllingefilet i ovn til familien. Serveres med ris.",
      trin: [
        "Forbered kyllingefilet i ovn efter opskrift.",
    ...
    ingredients: [
      { name: "Kyllingefilet", qty: "", url: "https://www.bilkatogo.dk/s?query=kyllingefilet" },
      { name: "Ris", qty: "", url: "https://www.bilkatogo.dk/s?query=ris" },
      { name: "Papryka", qty: "", url: "https://www.bilkatogo.dk/s?query=papryka" },
      { name: "Knobel", qty: "", url: "https://www.bilkatogo.dk/s?query=knobel" },
