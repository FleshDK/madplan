...
// Madplan uge 25 · 2026 · 15.06–21.06
// Opdateret af MasterKOK 👨‍🍳 søndag 14. juni 2026
// 4 personer (Lars, Louise, Maya, Karoline). Maya til koncert fredag 19/6
...
const madplan = [
  {
    ...
    dato: "15.06",
    emoji: "🍗",
    meal: "Kyllingelår BBQ med bådekartofler og salat",
    sidedish: "",
    note: "Rema-tilbud: Kyllingelår BBQ",
    color: "#f3e5f5",
    accent: "#7b1fa2",
    naering: {
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk kyllingelår bbq med bådekartofler og salat til familien. Serveres med .",
      trin: [
        "Forbered kyllingelår bbq med bådekartofler og salat efter opskrift.",
        "Tilbered  som tilbehør.",
        "Smag til med salt og peber.",
        "Server og nyd måltidet! 🍽️",
      ],
    },
    ingredients: [
      { name: "Kyllingelår BBQ", qty: "", url: "https://www.bilkatogo.dk/s?query=kyllingelår+bbq" },
      { name: "bådekartofler", qty: "", url: "https://www.bilkatogo.dk/s?query=bådekartofler" },
      { name: "salat", qty: "", url: "https://www.bilkatogo.dk/s?query=salat" },
    ],
  },
  {
    day: "Tirsdag",
    dato: "16.06",
    emoji: "🍗",
    meal: "Kyllingerester i wrap/tortilla",
    sidedish: "",
    note: "Rester fra mandag — fredelig dag",
    color: "#f3e5f5",
    accent: "#7b1fa2",
    naering: {
      hel: { kcal: 2800, protein: 200, kulhy: 240, fedt: 90 },
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk kyllingerester i wrap/tortilla til familien. Serveres med .",
      trin: [
        "Forbered kyllingerester i wrap/tortilla efter opskrift.",
        "Tilbered  som tilbehør.",
        "Smag til med salt og peber.",
        "Server og nyd måltidet! 🍽️",
      ],
    ...
    ingredients: [
      { name: "Kyllingerester", qty: "", url: "https://www.bilkatogo.dk/s?query=kyllingerester" },
      { name: "tortilla", qty: "", url: "https://www.bilkatogo.dk/s?query=tortilla" },
      { name: "salat", qty: "", url: "https://www.bilkatogo.dk/s?query=salat" },
    ],
  },
  {
    ...
    dato: "17.06",
    emoji: "🍽️",
    meal: "Hakkebøffer med kartofler og agurkesalat",
    sidedish: "",
    note: "⚠️ KRITISK: Diamantbryllup farmor/farfar kl. 18:00! Madaften må serveres tidligt (ca. 17:00 senest). Hakkebøffer = hurtig og nem ret.",
    color: "#f5f5f5",
    accent: "#424242",
    naering: {
      hel: { kcal: 2800, protein: 200, kulhy: 240, fedt: 90 },
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk hakkebøffer med kartofler og agurkesalat til familien. Serveres med .",
      trin: [
        "Forbered hakkebøffer med kartofler og agurkesalat efter opskrift.",
        "Tilbered  som tilbehør.",
        "Smag til med salt og peber.",
        "Server og nyd måltidet! 🍽️",
      ],
    ...
    ingredients: [
      { name: "Hakkebøffer", qty: "", url: "https://www.bilkatogo.dk/s?query=hakkebøffer" },
      { name: "kogte kartofler", qty: "", url: "https://www.bilkatogo.dk/s?query=kogte+kartofler" },
      { name: "agurkesalat", qty: "", url: "https://www.bilkatogo.dk/s?query=agurkesalat" },
    ],
  },
  {
    day: "Torsdag",
    dato: "18.06",
    emoji: "🍽️",
    meal: "Rødspættefileter med kogte kartofler og persillesovs",
    sidedish: "",
    note: "Rema-tilbud: Rødspættefileter. Familiens regel: fisk = kogte kartofler med persillesovs, IKKE ris.",
    color: "#f5f5f5",
    accent: "#424242",
    naering: {
      hel: { kcal: 2800, protein: 200, kulhy: 240, fedt: 90 },
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk rødspættefileter med kogte kartofler og persillesovs til familien. Serveres med .",
      trin: [
        "Forbered rødspættefileter med kogte kartofler og persillesovs efter opskrift.",
        "Tilbered  som tilbehør.",
        "Smag til med salt og peber.",
        "Server og nyd måltidet! 🍽️",
      ],
    ...
    ingredients: [
      { name: "Rødspættefileter", qty: "", url: "https://www.bilkatogo.dk/s?query=rødspættefileter" },
      { name: "kogte kartofler", qty: "", url: "https://www.bilkatogo.dk/s?query=kogte+kartofler" },
      { name: "persillesovs", qty: "", url: "https://www.bilkatogo.dk/s?query=persillesovs" },
    ],
  },
  {
    day: "Fredag",
    dato: "19.06",
    emoji: "🍝",
    meal: "Spaghetti Bolognese (hakket oksekød)",
    sidedish: "",
    note: "Maya til The Weeknd koncert kl. 20:00 🎵 — planlægges for 3 personer. Tilbered 17:00 så hun kan spise før koncert.",
    color: "#fff8e1",
    accent: "#f57f17",
    naering: {
      hel: { kcal: 2800, protein: 200, kulhy: 240, fedt: 90 },
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk spaghetti bolognese (hakket oksekød) til familien. Serveres med .",
      trin: [
        "Forbered spaghetti bolognese (hakket oksekød) efter opskrift.",
        "Tilbered  som tilbehør.",
        "Smag til med salt og peber.",
        "Server og nyd måltidet! 🍽️",
      ],
    ...
    ingredients: [
      { name: "Hakket oksekød", qty: "", url: "https://www.bilkatogo.dk/s?query=hakket+oksekød" },
      { name: "spaghetti", qty: "", url: "https://www.bilkatogo.dk/s?query=spaghetti" },
      { name: "tomat", qty: "", url: "https://www.bilkatogo.dk/s?query=tomat" },
  ...
  },
  {
    ...
    dato: "20.06",
    emoji: "🍽️",
    meal: "Marmoreret grillfilet på grill med bådekartofler og salat",
    sidedish: "",
    note: "Rema-tilbud: Marmoreret grillfilet. Diamantbryllup fejring kl. 13:30–14:30 (frokost). Aftensmad upåvirket — grill-mad i sommerkvalitet!",
    color: "#f5f5f5",
    accent: "#424242",
    naering: {
      hel: { kcal: 2800, protein: 200, kulhy: 240, fedt: 90 },
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk marmoreret grillfilet på grill med bådekartofler og salat til familien. Serveres med .",
      trin: [
        "Forbered marmoreret grillfilet på grill med bådekartofler og salat efter opskrift.",
        "Tilbered  som tilbehør.",
        "Smag til med salt og peber.",
        "Server og nyd måltidet! 🍽️",
      ],
    ...
    ingredients: [
      { name: "Marmoreret grillfilet", qty: "", url: "https://www.bilkatogo.dk/s?query=marmoreret+grillfilet" },
      { name: "grill", qty: "", url: "https://www.bilkatogo.dk/s?query=grill" },
      { name: "bådekartofler", qty: "", url: "https://www.bilkatogo.dk/s?query=bådekartofler" },
      { name: "salat", qty: "", url: "https://www.bilkatogo.dk/s?query=salat" },
    ],
  },
  {
    ...
    dato: "21.06",
    emoji: "🥩",
    meal: "Kalvemørbradsteg med kartofler og grønsagssovs",
    sidedish: "",
    note: "Søndagsmad med stil 🎩 — lidt luksus efter en travl uge med arrangementer. Rema-tilbud: Kalvemørbradsteg.",
    color: "#fff5ee",
    accent: "#bf360c",
    naering: {
      hel: { kcal: 2800, protein: 200, kulhy: 240, fedt: 90 },
    ...
    recipe: {
      tid: "30 min",
      svaerhed: "Let",
      intro: "Klassisk kalvemørbradsteg med kartofler og grønsagssovs til familien. Serveres med .",
      trin: [
        "Forbered kalvemørbradsteg med kartofler og grønsagssovs efter opskrift.",
        "Tilbered  som tilbehør.",
        "Smag til med salt og peber.",
        "Server og nyd måltidet! 🍽️",
      ],
    ...
    ingredients: [
      { name: "Kalvemørbradsteg", qty: "", url: "https://www.bilkatogo.dk/s?query=kalvemørbradsteg" },
      { name: "kartofler", qty: "", url: "https://www.bilkatogo.dk/s?query=kartofler" },
      { name: "grøntsager", qty: "", url: "https://www.bilkatogo.dk/s?query=grøntsager" },
      { name: "flødesovs", qty: "", url: "https://www.bilkatogo.dk/s?query=flødesovs" },
    ],
  }
]
